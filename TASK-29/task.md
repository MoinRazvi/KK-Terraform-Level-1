...
#
A S3 bucket named nautilus-bck-20476 already exists.

1) Copy the contents of nautilus-bck-20476 S3 bucket to /opt/s3-backup/ directory on terraform-client host (the landing host once you load this lab).

2) Delete the S3 bucket nautilus-bck-20476.
